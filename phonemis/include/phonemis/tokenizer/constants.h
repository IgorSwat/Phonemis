...
namespace phonemis::tokenizer::constants {
  ...
  inline const std::unordered_set<std::string> kSpecialWords = {
    ...
    "e.g.", "feb.", "f.b.i.", "f.d.r.", "fla.", "gen.", "gov.",
    "inc.", "jan.", "jr.", "ltd.", "mar.", "mass.", "md.", "mich.",
    "minn.", "miss.", "mo.", "mont.", "mr.", "mrs.", "mt.", "n.a.",
    "n.c.", "n.j.", "n.y.", "nov.", "oct.", "okla.", "ore.", "pa.",
    "prof.", "rev.", "sept.", "st.", "tenn.", "u.n.", "u.s.", "u.s.a.",
    "u.s.s.r.", "va.", "wash.", "wis.", "p.m.", "vs.",
...
} // namespace pos::tokenizer::constants